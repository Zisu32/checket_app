        ...
        return ValueListenableBuilder<List<WardrobeSlot>>(
          ...
          builder: (context, slots, _) {
            ...
            final slot = slots.firstWhere(
              ...
              orElse: () => WardrobeSlot(id: widget.ticketId, updatedAt: DateTime.now(), status: 'loading')
            );
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      else if (_showTimeoutMessage && slot.status == 'loading')
                      ...
                      if (slot.status == 'unpaid') 
                        ElevatedButton(
                          ...
                          onPressed: () {
                            //Implement Stripe Checkout call
                          }, 
